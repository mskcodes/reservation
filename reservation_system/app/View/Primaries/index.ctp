<div class="primaries index">
	<h2><?php echo __('Primaries'); ?></h2>
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $primary['Primary']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $primary['Primary']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
